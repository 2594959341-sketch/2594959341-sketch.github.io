...
const CORE = [
  'index.html?v=mumu-v339', 'manifest.json?v=mumu-v339', 'icon.svg?v=mumu-v339', 'css/style.css?v=mumu-v339', 'css/travel.css?v=mumu-v339',
  'js/app.js?v=mumu-v339', 'js/core.js?v=mumu-v339', 'js/daily.js?v=mumu-v339', 'js/work.js?v=mumu-v339', 'js/kaogong.js?v=mumu-v339',
  'js/growth.js?v=mumu-v339', 'js/sport.js?v=mumu-v339', 'js/meals.js?v=mumu-v339', 'js/review.js?v=mumu-v339', 'js/travel.js?v=mumu-v339',
  'js/finance.js?v=mumu-v339', 'js/fun.js?v=mumu-v339', 'js/theme.js?v=mumu-v339', 'js/streak.js?v=mumu-v339', 'js/freq.js?v=mumu-v339',
  'js/data/incentives.js?v=mumu-v339', 'js/data/shizheng.js?v=mumu-v339', 'js/data/kaogong.js?v=mumu-v339',
  'js/data/growth.js?v=mumu-v339', 'js/data/sport.js?v=mumu-v339', 'js/data/watch_games.js?v=mumu-v339', 'js/data/kepu.js?v=mumu-v339',
  'js/data/chinamap.js?v=mumu-v339',
  // 枝枝喵 · cat 主题（png/）
  ...CAT.map(n => 'assets/kitty/png/' + n + '?v=mumu-v339'),
  // 枝枝喵 · zhiya 主题（zhiya/）旧版枝丫
  ...ZHIYA.map(n => 'assets/kitty/zhiya/' + n + '?v=mumu-v339')
];
