...
const CORE = [
  'index.html?v=mumu-v306', 'manifest.json?v=mumu-v306', 'icon.svg?v=mumu-v306', 'css/style.css?v=mumu-v306', 'css/travel.css?v=mumu-v306',
  'js/app.js?v=mumu-v306', 'js/core.js?v=mumu-v306', 'js/daily.js?v=mumu-v306', 'js/work.js?v=mumu-v306', 'js/kaogong.js?v=mumu-v306',
  'js/growth.js?v=mumu-v306', 'js/sport.js?v=mumu-v306', 'js/meals.js?v=mumu-v306', 'js/review.js?v=mumu-v306', 'js/travel.js?v=mumu-v306',
  'js/finance.js?v=mumu-v306', 'js/fun.js?v=mumu-v306', 'js/theme.js?v=mumu-v306', 'js/streak.js?v=mumu-v306', 'js/freq.js?v=mumu-v306',
  'js/data/incentives.js?v=mumu-v306', 'js/data/shizheng.js?v=mumu-v306', 'js/data/kaogong.js?v=mumu-v306',
  'js/data/growth.js?v=mumu-v306', 'js/data/sport.js?v=mumu-v306', 'js/data/watch_games.js?v=mumu-v306', 'js/data/kepu.js?v=mumu-v306',
  'js/data/chinamap.js?v=mumu-v306',
  // 枝枝喵 · cat 主题（png/）
  ...CAT.map(n => 'assets/kitty/png/' + n + '?v=mumu-v306'),
  // 枝枝喵 · zhiya 主题（zhiya/）旧版枝丫
  ...ZHIYA.map(n => 'assets/kitty/zhiya/' + n + '?v=mumu-v306')
];
