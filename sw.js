...
const CORE = [
  'index.html?v=mumu-v312', 'manifest.json?v=mumu-v312', 'icon.svg?v=mumu-v312', 'css/style.css?v=mumu-v312', 'css/travel.css?v=mumu-v312',
  'js/app.js?v=mumu-v312', 'js/core.js?v=mumu-v312', 'js/daily.js?v=mumu-v312', 'js/work.js?v=mumu-v312', 'js/kaogong.js?v=mumu-v312',
  'js/growth.js?v=mumu-v312', 'js/sport.js?v=mumu-v312', 'js/meals.js?v=mumu-v312', 'js/review.js?v=mumu-v312', 'js/travel.js?v=mumu-v312',
  'js/finance.js?v=mumu-v312', 'js/fun.js?v=mumu-v312', 'js/theme.js?v=mumu-v312', 'js/streak.js?v=mumu-v312', 'js/freq.js?v=mumu-v312',
  'js/data/incentives.js?v=mumu-v312', 'js/data/shizheng.js?v=mumu-v312', 'js/data/kaogong.js?v=mumu-v312',
  'js/data/growth.js?v=mumu-v312', 'js/data/sport.js?v=mumu-v312', 'js/data/watch_games.js?v=mumu-v312', 'js/data/kepu.js?v=mumu-v312',
  'js/data/chinamap.js?v=mumu-v312',
  // 枝枝喵 · cat 主题（png/）
  ...CAT.map(n => 'assets/kitty/png/' + n + '?v=mumu-v312'),
  // 枝枝喵 · zhiya 主题（zhiya/）旧版枝丫
  ...ZHIYA.map(n => 'assets/kitty/zhiya/' + n + '?v=mumu-v312')
];
