...
const CORE = [
  'index.html?v=mumu-v333', 'manifest.json?v=mumu-v333', 'icon.svg?v=mumu-v333', 'css/style.css?v=mumu-v333', 'css/travel.css?v=mumu-v333',
  'js/app.js?v=mumu-v333', 'js/core.js?v=mumu-v333', 'js/daily.js?v=mumu-v333', 'js/work.js?v=mumu-v333', 'js/kaogong.js?v=mumu-v333',
  'js/growth.js?v=mumu-v333', 'js/sport.js?v=mumu-v333', 'js/meals.js?v=mumu-v333', 'js/review.js?v=mumu-v333', 'js/travel.js?v=mumu-v333',
  'js/finance.js?v=mumu-v333', 'js/fun.js?v=mumu-v333', 'js/theme.js?v=mumu-v333', 'js/streak.js?v=mumu-v333', 'js/freq.js?v=mumu-v333',
  'js/data/incentives.js?v=mumu-v333', 'js/data/shizheng.js?v=mumu-v333', 'js/data/kaogong.js?v=mumu-v333',
  'js/data/growth.js?v=mumu-v333', 'js/data/sport.js?v=mumu-v333', 'js/data/watch_games.js?v=mumu-v333', 'js/data/kepu.js?v=mumu-v333',
  'js/data/chinamap.js?v=mumu-v333',
  // 枝枝喵 · cat 主题（png/）
  ...CAT.map(n => 'assets/kitty/png/' + n + '?v=mumu-v333'),
  // 枝枝喵 · zhiya 主题（zhiya/）旧版枝丫
  ...ZHIYA.map(n => 'assets/kitty/zhiya/' + n + '?v=mumu-v333')
];
