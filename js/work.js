...
const Work = {
  ...
  render_cal(box, root) {
    ...
    const restSet = new Set([].concat(S.get('workRest', []) || [], annualHolidaySet('2020-01-01', '2050-12-31'), sickSetInRange('2020-01-01', '2050-12-31'))); // 排除月经假：月经假走粉色 menstrualSet；病假走专属蓝色；创作连续天数由 Streak.covered 统一处理（已含月经假+年度假期+病假）
